...
namespace BondPricer
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label2.Location = new System.Drawing.Point(184, 413);
            ...
            this.label3.Location = new System.Drawing.Point(385, 413);
            ...
            this.chart1.Location = new System.Drawing.Point(40, 76);
            ...
            this.label5.Location = new System.Drawing.Point(344, 36);
...
namespace BondPricer
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                double time = (i + 1) / (double)paymentFrequency;
                chart1.Series["Interest Rate Path"].Points.AddXY(time, interestRatePath[i]);
            }
            ...
            chart1.ChartAreas[0].AxisX.Maximum = maturityRate;
...
namespace BondPricer
{
   ...
   // Calculate the total number of time periods
    ...
    // Display the interest rate path on the chart
    for (int i = 0; i <= totalPeriods; i++) // Modified: Changed the condition to <= totalPeriods
    {
        double time = i / (double)paymentFrequency;
        chart1.Series["Interest Rate Path"].Points.AddXY(time, interestRatePath[i]);
    }

            // Set the minimum and maximum values for the x-axis
            chart1.ChartAreas[0].AxisX.Minimum = 0;
            chart1.ChartAreas[0].AxisX.Maximum = maturityRate; // Updated: Set maximum to maturityRate
